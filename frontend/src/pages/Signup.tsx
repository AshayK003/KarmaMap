      ...
      <Card className="w-full max-w-md p-6 sm:p-8">
        ...
        <form onSubmit={handleSubmit(onSubmit)} className="space-y-4" noValidate>
          ...
          <div className="space-y-1">
            <label htmlFor="signup-name" className="text-xs font-bold text-gray-500 dark:text-slate-300 uppercase tracking-wider block">Full Name</label>
          ...
          {/* Email input field */}
          <div className="space-y-1">
            <label htmlFor="signup-email" className="text-xs font-bold text-gray-500 dark:text-slate-300 uppercase tracking-wider block">Email Address</label>
            <div className="relative">
              <span className="absolute inset-y-0 left-0 flex items-center pl-3.5 text-slate-400 select-none pointer-events-none" aria-hidden="true">
                <svg className="h-4 w-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          ...
          <div className="space-y-1">
            <label htmlFor="signup-password" className="text-xs font-bold text-gray-500 dark:text-slate-300 uppercase tracking-wider block">Password</label>
            <div className="relative">
              <span className="absolute inset-y-0 left-0 flex items-center pl-3.5 text-slate-400 select-none pointer-events-none" aria-hidden="true">
                <svg className="h-4 w-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          ...
          {role === 'volunteer' && (
            <div className="space-y-1 animate-fade-in">
              <label htmlFor="signup-skills" className="text-xs font-bold text-gray-500 dark:text-slate-300 uppercase tracking-wider block">Skills (comma-separated)</label>
              <div className="relative">
                <span className="absolute inset-y-0 left-0 flex items-center pl-3.5 text-slate-400 select-none pointer-events-none" aria-hidden="true">
                  <svg className="h-4 w-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
