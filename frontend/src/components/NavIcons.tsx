...
export function AwardIcon(props: Props) {
  return (
    <Icon {...props}>
...
export function ClipboardListIcon(props: Props) {
  return (
    <Icon {...props}>
      <rect width="8" height="14" x="8" y="4" rx="2" ry="2" />
...
export function UserCircleIcon(props: Props) {
  return (
    <Icon {...props}>
      <circle cx="12" cy="12" r="10" />
      <circle cx="12" cy="10" r="3" />
      <path d="M7 20.662V19a3 3 0 0 1 3-3h4a3 3 0 0 1 3 3v1.662" />
    </Icon>
  );
}

export function Building2Icon(props: Props) {
  return (
    <Icon {...props}>
