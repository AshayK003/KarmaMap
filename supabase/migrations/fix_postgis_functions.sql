-- Run this if you already applied the main migration but hit:
--   ERROR: type "geometry" does not exist
--
-- Prerequisites:
--   1. Enable "postgis" under Database → Extensions
--   2. CREATE EXTENSION IF NOT EXISTS postgis WITH SCHEMA extensions;

CREATE EXTENSION IF NOT EXISTS postgis WITH SCHEMA extensions;

-- Recreate nearby_gigs with correct search_path
